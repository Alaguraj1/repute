...
import award_img_2 from "@assets/img/award/9/award-2.jpg";
import award_img_3 from "@assets/img/award/9/award-3.jpg";
import award_img_4 from "@assets/img/award/9/award-4.jpg";
...
const PortfolioAwards = ({style_2=false}) => {
  return (
    <>
      <section className={`award__area pt-120 pb-${style_2?'120':'10'} pb-10 white-bg`}>
        <div className="container">
          <div className="row">
            <div className="col-xxl-12">
              <div className={`section__title-wrapper-9 mb-55 ${style_2?'text-center':''}`}>
            ...
            <div className="col-xxl-12">
              <div className="award__item-wrapper-9">
                {award_data.map((award, i) => {
                  const { id, data_src, delay, subtitle, title, topic } = award;
                  return (
